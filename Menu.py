...
class Menu:
    ...
    def menu_page(self):
        ...
        quick_play_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((x, y), (self.button_width, self.button_height)), text="Quick Play", manager=self.manager)
    ...
    #     y += 100
    #     start_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((self.middle, self.screen_height-self.button_height-10), (self.button_width, self.button_height)), text="Start", manager = self.manager)
    #
    #     new_game = Game(self.min_rows, self.min_cols, self.min_sequ_len, self.min_num_targets, self.min_row_space, self.min_col_space, self.min_num_grids, self.right_color, self.left_color, False)
    #
    ...
    #                         if int(rows_textbox.html_text) > self.min_rows-1:
    #                             new_game.rows = int(rows_textbox.html_text) - 1
    #                             print("the new row number is ", new_game.rows)
    #
    ...
    def mode_page(self):
        ...
        num_grids_textbox = pygame_gui.elements.UITextBox(relative_rect=pygame.Rect((self.middle, y), (100, 50)), html_text= str(self.min_num_grids), manager=self.manager)
        y += 100
    ...
    def settings_page(self):
        ...
        color = (255, 0, 0)
        left_rect_y = 120
        left_y = color_height + left_rect_y + label_gap
        left_eye_button = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((self.middle, left_y), (self.button_width, self.button_height)),text="Left Eye",manager=self.manager)
        right_rect_y = left_y + 30 + self.button_height
        right_y = right_rect_y + label_gap + color_height
        right_eye_button = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((self.middle, right_y), (self.button_width, self.button_height)),text="Right Eye",manager=self.manager)
        ...
        while running:
            ...
            rect1 = pygame.draw.rect(self.screen, self.left_color, pygame.Rect(self.middle, left_rect_y, color_width, color_height))
            rect2 = pygame.draw.rect(self.screen, self.right_color, pygame.Rect(self.middle, right_rect_y, color_width, color_height))
            pygame.display.update()
