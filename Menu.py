...
class Home:
    ...
    def quick_play_menu_page(self):
        ...
        easy_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((x, y), (self.button_width, self.button_height)), text="Easy", manager=self.manager)
        medium_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((x, y + 100), (self.button_width, self.button_height)), text="Medium", manager=self.manager)
        hard_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((x, y + 200), (self.button_width, self.button_height)), text="Hard", manager=self.manager)
        start_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((x, y + 350), (self.button_width, self.button_height)), text="Start", manager=self.manager)
        ...
        quick_game = Game_With_Set_Params(self.min_rows, self.min_cols, self.min_sequ_len,
                                          self.min_num_targets, self.min_row_space, self.min_col_space,
                                          self.min_num_grids, self.right_color, self.left_color, False)
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                        ...
                        if event.ui_element == easy_button:
                            quick_game = Game_With_Set_Params(r.randint(4, 6), r.randint(4, 6), r.randint(1, 2), r.randint(1, 3), self.min_row_space, self.min_col_space, 1, self.right_color, self.left_color, False)
                            start_button.enable()

                        elif event.ui_element == medium_button:

                            quick_game = Game_With_Set_Params(r.randint(5, 7), r.randint(5, 7), r.randint(2, 3),
                                                              r.randint(1, 3), self.min_row_space, self.min_col_space,
                                                              self.right_color, self.left_color, False)

                        elif event.ui_element == hard_button:
                            quick_game = Game_With_Set_Params(r.randint(6, 8), r.randint(6, 8), r.randint(3, 4),r.randint(1, 3), self.min_row_space, self.min_col_space,self.right_color, self.left_color, False)
                            start_button.enable()
                        start_button.enable()
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                        if event.ui_element == back_button:
                            ...
                            new_game = Game_With_Set_Params(self.min_rows, self.min_cols, self.min_sequ_len,
                                                              self.min_num_targets, self.min_row_space,
                                                              self.min_col_space,
                                                              self.min_num_grids, self.right_color, self.left_color,
                                                              False)
                            new_game.run()
